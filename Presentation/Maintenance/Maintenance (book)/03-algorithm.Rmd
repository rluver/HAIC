...
```{r echo = F, out.width = 700, fig.cap = 'CNN Architecture', fig.align = 'center'}
...
knitr::include_graphics('./images/Chapter_03/rnn_block.png')
```
...
```{r echo = F, out.width = 700, fig.cap = 'LSTM Block', fig.align = 'center'}
knitr::include_graphics('./images/Chapter_03/lstm_block.png')
```
...
```{r echo = F, out.width = 700, fig.cap = 'GRU Block', fig.align = 'center'}
knitr::include_graphics('./images/Chapter_03/gru_block.png')
```
